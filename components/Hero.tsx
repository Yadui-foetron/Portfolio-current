...
const Hero: React.FC = () => {
  return (
    <section className="min-h-[90vh] md:min-h-screen pt-20 md:pt-28 pb-8 px-4 md:px-6 flex flex-col items-center justify-center relative overflow-hidden bg-transparent">
      <div className="max-w-6xl w-full text-center z-10">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[7.5rem] font-black leading-[0.9] mb-4 md:mb-6 uppercase tracking-tighter break-words">
        ...
        <p className="max-w-2xl mx-auto text-base md:text-xl lg:text-2xl font-bold mb-8 text-gray-800 leading-tight px-4">
      ...
      <div className="absolute top-[10%] left-[5%] w-16 h-16 md:w-24 md:h-24 floating opacity-30 md:opacity-60 z-20">
      ...
      <div className="absolute top-[15%] right-[5%] w-20 h-20 md:w-32 md:h-32 floating opacity-30 md:opacity-60 z-20" style={{ animationDelay: '1.5s' }}>
